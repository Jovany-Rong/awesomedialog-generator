...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionFromText = QAction(MainWindow)
        self.actionFromText.setObjectName(u"actionFromText")
        self.actionFromExcel = QAction(MainWindow)
        self.actionFromExcel.setObjectName(u"actionFromExcel")
        self.actionFromJson = QAction(MainWindow)
        self.actionFromJson.setObjectName(u"actionFromJson")
        ...
        self.menuImport.addAction(self.actionFromText)
        self.menuImport.addAction(self.actionFromExcel)
        self.menuImport.addAction(self.actionFromJson)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionFromText.setText(QCoreApplication.translate("MainWindow", u"\u6765\u81ea\u6587\u672c", None))
        self.actionFromExcel.setText(QCoreApplication.translate("MainWindow", u"\u6765\u81eaExcel", None))
        self.actionFromJson.setText(QCoreApplication.translate("MainWindow", u"\u6765\u81eaJSON", None))
        self.actionVersion.setText(QCoreApplication.translate("MainWindow", u"\u67e5\u770b\u7248\u672c", None))
        self.actionManual.setText(QCoreApplication.translate("MainWindow", u"\u5e2e\u52a9\u6587\u6863", None))
        self.actionWebsite.setText(QCoreApplication.translate("MainWindow", u"\u5b98\u65b9\u7f51\u7ad9", None))
        ...
        self.menuImport.setTitle(QCoreApplication.translate("MainWindow", u"\u5bfc\u5165", None))
